...
use super::{
    ...
    WorkspaceDataInner, WorkspaceGlobalData, WorkspaceHandler, WorkspaceState,
};
...
pub fn send_workspace_to_client(
    ...
    let cosmic_v2_capabilities =
        WorkspaceCapabilities::Rename | WorkspaceCapabilities::SetTilingState;
    if handle_state.capabilities & cosmic_v2_capabilities
        != workspace.capabilities & cosmic_v2_capabilities
    {
        let caps = workspace
            .capabilities
            .iter()
        ...
        handle_state.capabilities = (handle_state.capabilities & !cosmic_v2_capabilities)
            | (workspace.capabilities & cosmic_v2_capabilities);
        changed = true;
    }
